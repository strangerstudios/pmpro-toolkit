# Contribute to Paid Memberships Pro - Developer’s Toolkit
...
* For bug fixes, checkout the DEV branch of the Paid Memberships Pro - Developer’s Toolkit repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-toolkit.git` to set the upstream repo
...
* For bug fixes, submit a pull request to the DEV branch of the Paid Memberships Pro - Developer’s Toolkit repository.
