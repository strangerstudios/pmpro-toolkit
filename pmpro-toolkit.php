...
/**
 * Initialize the plugin after PMPro is loaded.
 *
 * Uses defined( 'PMPRO_VERSION' ) instead of is_plugin_active() so the check
 * works regardless of PMPro's folder name (e.g. release candidates) and
 * regardless of plugin load order.
 *
 * @return void
 * @since 1.1.1
 */
function pmprodev_plugins_loaded() {
...
add_action( 'plugins_loaded', 'pmprodev_plugins_loaded' );